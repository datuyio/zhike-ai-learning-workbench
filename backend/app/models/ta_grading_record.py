...
class TaGradingRecord(Base):
    ...
    reference_answer: Mapped[str | None] = mapped_column(Text, nullable=True, comment="AI 批改参考/标准答案")
    objective_score: Mapped[float | None] = mapped_column(Float, nullable=True, comment="多题作业中客观题自动判分得分，AI 批改主观部分后汇总")
